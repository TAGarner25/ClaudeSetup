---
title: Infographics Prompts
description: This document contains prompts for creating infographics with Google Gemini and Nano Banana.
source: https://www.reddit.com/r/ThinkingDeeplyAI/comments/1pjpfpb/here_are_30_gemini_nano_banana_prompts_for/
created: 2026-04-16
updated: 2026-04-16
---
...
* **Aspect Ratio Matters**: 
    * By default, Gemini generates squares. 
    * For infographics, almost always append --ar 9:16 (for mobile/Pinterest) or --ar 16:9 (for presentations) to your prompt if the platform allows, or specify Vertical Layout clearly in the text prompt.

* **The 400-Word Limit for Text Clarity**: 
    * To ensure near-perfect text rendering (99%+ accuracy in my testing), try to keep the total amount of text in your image prompt under 400 words. 
    * Going over can sometimes lead to hallucinations or garbled text.

* **The Spelling Check**: 
    * Gemini 3 is great at spelling, but not perfect. 
    * If it misspells a headline, don't throw the image away. 
    * Use the internal In-painting or Edit tool to highlight the text area and type Correct text to read: [Correct Spelling].

* **Watermarks & Subscriptions**: 
    * If you are a Gemini Ultra subscriber, you can generate infographics without the Gemini watermark in the corner.

* **Level Up with AI Studio**: 
    * For the absolute best results, use Google AI Studio instead of the standard Gemini interface. 
    * It costs about 6 cents per image via API key, but you get higher quality overall, can force 2K or 4K resolution, use Google Search grounding for factual accuracy, and remove the Gemini watermark entirely.
