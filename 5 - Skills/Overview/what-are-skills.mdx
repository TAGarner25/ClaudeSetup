...
*Sourced from [AgentSkills](https://github.com/agentskills/agentskills) repository. For more information see the open spec website [here](https://agentskills.io/home)*
